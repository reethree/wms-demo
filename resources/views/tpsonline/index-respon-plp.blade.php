...
<div class="box">
    ...
    <div class="box-body table-responsive">
        ...
        {{
            ...
            ->addColumn(array('label'=>'Kode Kantor','index'=>'KD_KANTOR','width'=>160,'hidden'=>true))
            ->addColumn(array('label'=>'Kode TPS','index'=>'KD_TPS','width'=>160,'hidden'=>true))
            ...
            ->addColumn(array('label'=>'No. Surat PLP','index'=>'NO_SURAT_PLP','width'=>160,'hidden'=>true))
            ->addColumn(array('label'=>'Tgl. Surat PLP','index'=>'TGL_SURAT_PLP','width'=>160,'hidden'=>true))
