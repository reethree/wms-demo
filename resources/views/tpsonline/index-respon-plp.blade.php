...
//            ->addColumn(array('key'=>true,'index'=>'tps_responplptujuanxml_pk','hidden'=>true))
            ...
            ->addColumn(array('label'=>'No. PLP','index'=>'tps_responplptujuanxml.NO_PLP','width'=>160,'align'=>'center'))
            ->addColumn(array('label'=>'Tgl. PLP','index'=>'tps_responplptujuanxml.TGL_PLP','width'=>160,'align'=>'center'))
