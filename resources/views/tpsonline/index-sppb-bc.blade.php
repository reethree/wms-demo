...
<script>
    ...
    function gridCompleteEvent()
    {
        ...
        for(var i=0;i < ids.length;i++){ 
            ...
            edt = '<a href="{{ route("tps-sppbBc-edit",'') }}/'+cl+'"><i class="fa fa-pencil"></i> Details</a> ';
...
<div class="box">
    ...
    <div class="box-body table-responsive">
        ...
        {{
            ...
            ->enableFilterToolbar()
            ->setGridOption('url', URL::to('/tpsonline/penerimaan/sppb-bc/grid-data'))
            ...
            ->addColumn(array('label'=>'Kode Pengawas','index'=>'KD_KANTOR_PENGAWAS','width'=>160))
            ->addColumn(array('label'=>'Kode Bongkar','index'=>'KD_KANTOR_BONGKAR','width'=>160))
