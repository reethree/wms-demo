            ...
            <div class="col-md-8">
                ...
                <div class="col-xs-3">
                    <select class="form-control select2" id="by" name="by" style="width: 100%;" tabindex="-1" aria-hidden="true">
                        ...
                        <option value="TGLSTRIPPING">Tgl. Stripping</option>                           
                    </select>
                </div>
                <div class="col-xs-3">
...
//            ->addColumn(array('label'=>'No. Job Order','index'=>'NoJob', 'width'=>150))
            ...
            ->addColumn(array('label'=>'Total BL','index'=>'jumlah_bl', 'width'=>100,'align'=>'center'))
            ...
            ->addColumn(array('label'=>'Tujuan MTY','index'=>'NAMADEPOMTY', 'width'=>200,'align'=>'left','hidden'=>true))
            ->addColumn(array('label'=>'No. POL MTY','index'=>'NOPOL_MTY', 'width'=>120,'align'=>'center','hidden'=>true))
