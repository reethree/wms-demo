            ...
            <div class="row">
                ...
                <div class="col-md-6"> 
                    <div class="form-group">                       
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="KODE_GUDANG" value="PNJP" class="form-control" required readonly>
                        </div>
                        <label class="col-sm-2 control-label">Tujuan</label>
                        <div class="col-sm-3">
                            <input type="text" name="GUDANG_TUJUAN" value="PNJP" class="form-control" required readonly>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="TNO_BC11" class="form-control" required value="{{ old('NO_BC11') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TTGL_BC11" class="form-control pull-right datepicker" required value="{{ old('TGL_BC11') }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
