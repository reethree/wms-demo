        ...
        <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-12"> 
                {{
                    ...
                    ->addColumn(array('label'=>'KD DOK','index'=>'KD_DOK_INOUT', 'width'=>100,'hidden'=>false))
                    ->addColumn(array('label'=>'Kode Dokumen','index'=>'KODE_DOKUMEN', 'width'=>100,'hidden'=>false, 'align'=>'center'))                   
