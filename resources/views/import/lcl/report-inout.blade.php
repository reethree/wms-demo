...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Report IN OUT LCL</h3>
<!--        <div class="box-tools">
...
<script type="text/javascript">
    ...
    $('#searchByDateBtn').on("click", function(){
        ...
        jQuery("#lclInoutReportGrid").jqGrid('setGridParam',{url:"{{URL::to('/lcl/manifest/grid-data')}}?startdate="+startdate+"&enddate="+enddate}).trigger("reloadGrid");
        return false;
    });
</script>
