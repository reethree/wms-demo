        ...
        <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-12"> 
                {{
                    ...
                    ->enableFilterToolbar()
                    ->setGridOption('url', URL::to('/tpsonline/penerimaan/ob-fcl/grid-data?jenis=F'))
                    ...
                    ->addColumn(array('label'=>'Ukuran Cont.','index'=>'UK_CONT','width'=>160,'align'=>'center'))		
                    ->addColumn(array('label'=>'No. Segel','index'=>'NO_SEGEL','width'=>160,'align'=>'center'))	
                    ...
                    ->addColumn(array('label'=>'Bruto','index'=>'BRUTO','width'=>80,'align'=>'center'))	
