...
<div class="box">
    ...
    <div class="box-body table-responsive">
        {{
            ...
            ->addColumn(array('label'=>'Created','index'=>'datetime_created','width'=>120,'align'=>'center'))
            ->addColumn(array('label'=>'Expired','index'=>'datetime_expired','width'=>120,'align'=>'center'))
            ->addColumn(array('label'=>'Last Update','index'=>'datetime_last_updated','width'=>120,'align'=>'center'))
            ->addColumn(array('label'=>'Payment Date','index'=>'datetime_payment','width'=>120,'align'=>'center'))                             
            ->addColumn(array('label'=>'Payment<br />Ref Number','index'=>'payment_ntb','width'=>100,'align'=>'center'))
            ...
            ->addColumn(array('label'=>'VA Status<br />1=active<br />2=inactive','index'=>'va_status','width'=>60,'align'=>'center'))
