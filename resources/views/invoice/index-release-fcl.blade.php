...
//        $('#btn-toolbar').disabledButtonGroup();
            ...
            $('#btn-invoice').on("click", function(){
                ...
                $('#alamat').val($grid.jqGrid("getCell", selIds[0], "ALAMAT_IMP"));
                $('#jenis_container').val($grid.jqGrid("getCell", selIds[0], "jenis_container")).trigger("change");
                if($grid.jqGrid("getCell", selIds[0], "BEHANDLE") == 'Y'){
                    $('#behandle').bootstrapSwitch('state', true);
                }else{
                    $('#behandle').bootstrapSwitch('state', false);
                }
            ...
            <div class="row">
                <div class="col-md-12">
                    {{
                        ...
                        ->addColumn(array('label'=>'Behandle','index'=>'BEHANDLE','width'=>100,'align'=>'center','hidden'=>false))
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="checkbox" class="check-switch" name="behandle" value="1" id="behandle" />
                                    </div>
                                </div>
{{--                                <div class="form-group">--}}
{{--                                    <label class="col-sm-3 control-label">Jenis Container</label>--}}
{{--                                    <div class="col-sm-6">--}}
{{--                                        <select class="form-control select2" id="jenis_container" name="jenis_container" style="width: 100%;" tabindex="-1" aria-hidden="true">--}}
