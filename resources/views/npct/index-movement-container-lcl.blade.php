...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Data Container LCL</h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    {{
                        ...
                        ->setGridOption('url', URL::to('/container/grid-data?module=release_movement&_token='.csrf_token()))
    ...
    //                    ->setGridEvent('gridComplete', 'gridCompleteEvent')
                       ...
                       // ->addColumn(array('label'=>'Tgl. POS BC11','index'=>'NO_POS_BC11','width'=>120,'align'=>'center'))
                        ...
                        ->addColumn(array('label'=>'Tgl. Empty','index'=>'TGLBUANGMTY','width'=>150,'align'=>'center'))
                        ->addColumn(array('label'=>'Jam. Empty','index'=>'JAMBUANGMTY', 'width'=>120,'align'=>'center'))
