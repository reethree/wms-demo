...
//                  ->setFilterToolbarEvent('beforeSearch', 'function(){}')
                ->addColumn(array('index'=>'eseal_id','hidden'=>true))
                ->addColumn(array('label'=>'E-Seal Kode','index'=>'esealcode','width'=>150))
                ->addColumn(array('label'=>'Keterangan','index'=>'keterangan', 'width'=>380))
